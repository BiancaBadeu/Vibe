...
public class Manager implements Model
{
  ...
  {
    return sessionList.getUnbookedSessionsForCourse(course);
  }
  //room
  ...
  public ArrayList<Room> getRoomsAvailableInPeriodBySizeBiggerThanUnitable(int capacity, DateTime startTime, DateTime endTime)
  {
    return sessionList.getRoomsAvailableInPeriodBySizeBiggerThanUnitable(capacity, startTime, endTime, roomList);
  }
  public ArrayList<Room> getRoomsAvailableInPeriodBySizeBiggerThanNotUnitable(int capacity, DateTime startTime, DateTime endTime)
  {
    return sessionList.getRoomsAvailableInPeriodBySizeBiggerThanNotUnitable(capacity, startTime, endTime, roomList);
  }
