...
public interface Model
{
  ...
  ArrayList<Session> getUnbookedSessionsForCourse(Course course);
  //room
  ...
  ArrayList<Room> getRoomsAvailableInPeriodBySizeBiggerThanUnitable(int capacity, DateTime startTime, DateTime endTime);
  ArrayList<Room> getRoomsAvailableInPeriodBySizeBiggerThanNotUnitable(int capacity, DateTime startTime, DateTime endTime);
