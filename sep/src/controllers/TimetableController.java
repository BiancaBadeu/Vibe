...
public class TimetableController
{
  ...
  public void init(ViewHandler viewHandler, Model model, Region root)
  {
    ...
    TableColumn dayNumber = new TableColumn("Day of the week");
    ...
    timetable.getColumns().setAll(dayNumber, startTime, endTime, room, sessionNumberCol, course, numberOfLessons, numberOfLessonsForCourse, getNumberOfLessonsRemaining);
