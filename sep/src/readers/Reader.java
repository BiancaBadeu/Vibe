    ...
    while (in.hasNext())
    {
      ...
      if(roomId.equals("null"))
      {
        ...
        else
        {
          ...
          d = Integer.parseInt(splittingline[9].trim());
          m = Integer.parseInt(splittingline[10].trim());
          y = Integer.parseInt(splittingline[11].trim());
          h = Integer.parseInt(splittingline[12].trim());
          min = Integer.parseInt(splittingline[13].trim());
